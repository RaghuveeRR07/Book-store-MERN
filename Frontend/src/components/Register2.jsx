...
export function Register({ onSwitchToLogin }) {
    ...
    const {
      ...
      const onSubmit = async (data) => {
        ...
        await  axios.post('http://localhost:8000/api/v1/users/signup', userInfo)
        .then((res) => {
        ...
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <p className="mt-2 text-center text-base text-gray-200" >
            ...
            <a
              href="#"
              title=""
              className="font-medium text-red-600 transition-all duration-200 hover:underline" onClick={onSwitchToLogin}
            >
              Sign In
            </a>
          </p>
