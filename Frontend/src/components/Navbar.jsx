...
useEffect(()=>{
    ...
    const navItems = (
        ...
        <li><a><Link to="/Courses">Patterns</Link></a></li>
        <li><a>About</a></li>
        <li><a>Contact</a></li>
        </>
    )
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer "><Link to='/'>Crochet Gemini</Link></a>
  </div>
  <div className="navbar-end space-x-3 gap-3">
